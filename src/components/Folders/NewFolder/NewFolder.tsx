...
export default class NewFolder extends React.PureComponent<IProps, IState> {
    ...
    public render():JSX.Element | null{
        return this.props.isActive ? (<div className="create-folder-popup popup">
        <span className="close-popup" onClick={this.props.onCloseClick}><i className="icon-clear"/></span>
