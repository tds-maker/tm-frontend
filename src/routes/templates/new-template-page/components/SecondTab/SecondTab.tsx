...
export default class SecondTab extends React.PureComponent<IProps> {
  ...
  public render() {
    ...
    return (<div style={{ display: 'table', width: '100%' }}>
      <div className="tab-col">
        ...
        <Input
          placeholder="Please write template name"
        ...
        <SelectList
            ...
            items={this.productNumberOptions}
            selectedValue={template.productNumberOption}
            onChange={this.onProductNumberOptionsChnage}
          />
      </div>
      <div className="tab-col">
          ...
          <div className="input-col">
            <CheckBox
              id="en"
              label="English"
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('en') >= 0}
            />
            <CheckBox
              id="gr"
              label="German"
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('gr') >= 0}
            />
            <CheckBox
              id="fr"
              label="French"
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('fr') >= 0}
            />
          </div>
          <div className="input-col">
            <CheckBox
              ...
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('tr') >= 0}
            />
            <CheckBox
              id="zh-cn"
              label="Chinese"
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('zh-cn') >= 0}
            />
            <CheckBox
              id="hu"
              label="Hungarian"
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('hu') >= 0}
            />
          </div>
          <div className="input-col">
            <CheckBox
              ...
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('es') >= 0}
            />
            <CheckBox
              id="el"
              label="Greek"
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('el') >= 0}
            />
            <CheckBox
              id="ru"
              label="Russian"
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('ru') >= 0}
            />
          </div>
          <div className="input-col">
            <CheckBox
              ...
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('it') >= 0}
            />
            <CheckBox
              id="id"
              label="Indonesian"
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('id') >= 0}
            />
            <CheckBox
              id="vi"
              label="Vietnamese"
              onChange={this.onLanguageCheck}
              rounded={true}
              checked={template.languages.indexOf('vi') >= 0}
            />
          </div>
          <br />
          ...
          <SelectList
            placeholder="Select an item"
            selectedValue={template.primaryLanguage}
            items={this.primaryLanguageOptions()}
            width="300px"
            onChange={this.onPrimaryLanguageSelected}
          />
  ...
  private onLanguageCheck(e:any){
    if(this.props.dispatch){
      this.props.dispatch(selectLanguage({ language : e.target.id, isSelected: e.target.checked }));
    }
  }
  ...
  private primaryLanguageOptions():ISelectItem[]{
    ...
    return this.props.template.languages.map(l => ({ value : l, text : allLanguages[l]}));
  }
