...
describe('NewTemplate First Tab Component', () => {
  ...
  beforeEach(() => {
    ...
    wrapper = shallow(<SecondTab template={template} />);
  ...
  describe('First column', () => {
    ...
    it('should have correct children', () => {
      ...
      expect(firstColumn.childAt(3).props().items).toEqual([ { value: 'optional', text: 'Optional' },{ value: 'must', text: 'Must' },{ value: 'unique', text: 'Unique' },{ value: 'None', text: 'None' } ]);
